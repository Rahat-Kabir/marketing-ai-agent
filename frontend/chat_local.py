        ...
        **kwargs
        ...
        if isinstance(message_chunk, AIMessageChunk):
            ...
            if message_chunk.tool_call_chunks:
                ...
                if tool_name:
                    tool_call_str = f"\n\n< TOOL CALL: {tool_name} >\n\n"
                    # Special handling for visualization tool
                    if tool_name == "generate_visualization":
                        tool_call_str += "🎨 [VISUALIZATION] Creating interactive chart... This may take a moment.\n"
                        tool_call_str += "📊 Chart will auto-open in your browser when ready.\n"
                if args:
                    tool_call_str = args
                ...
                # Enhanced visualization feedback
                if "📊 Chart Generated Successfully!" in content:
                    content += "\n\n💡 [TIP] Chart should have opened automatically in your browser!"
                    content += "\n🔧 [VIEWER] Use 'python chart_viewer.py' for advanced chart management"
                elif "❌" in content and "visualization" in content.lower():
                    content += "\n\n🔧 [HELP] Try checking your SQL syntax and plotly code"
                    content += "\n📚 [DOCS] Use the chart viewer for examples: python chart_viewer.py"
                yield content
            continue
