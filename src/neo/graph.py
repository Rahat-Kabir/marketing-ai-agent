...
from neo.my_mcp.config import mcp_config
from neo.prompts import neo_system_prompt
import json
...
class  AgentState(BaseModel):
    ...
    protected_tools: List[str] = ["create_campaign", "send_campaign_email", "create_social_media_campaign", "generate_social_media_post"]
...
async def build_graph():
    ...
    def assistant_node(state: AgentState) -> AgentState:
        response = llm.invoke(
            [SystemMessage(content=neo_system_prompt)] +
            state.messages
            )
